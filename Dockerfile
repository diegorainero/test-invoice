...
RUN set -eux; \
	...
	composer global require "symfony/form" --prefer-dist --no-progress --no-suggest --classmap-authoritative; \
	composer global require "symfony/dotenv" --prefer-dist --no-progress --no-suggest --classmap-authoritative; \
	composer global require "symfony/webpack-encore-bundle" --prefer-dist --no-progress --no-suggest --classmap-authoritative; \
	composer global require "twbs/bootstrap" --prefer-dist --no-progress --no-suggest --classmap-authoritative; \
	composer global require "symfony/profiler-pack" --prefer-dist --no-progress --no-suggest --classmap-authoritative; \
	composer global require "symfony/asset" --prefer-dist --no-progress --no-suggest --classmap-authoritative; \
	composer global require "symfony/validator" --prefer-dist --no-progress --no-suggest --classmap-authoritative; \
...
RUN yarn add sass-loader node-sass --dev; \
	  yarn add jquery bootstrap bootstrap-sass \
